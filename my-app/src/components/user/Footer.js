  ...
  return (
    ...
    <footer  className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div  className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className>
              ...
              <p className="mb-4">
                <Link to="Landing" className="text-neutral-600 dark:text-neutral-200">Home</Link>
              </p>
              <p className="mb-4">
                <Link to="About" className="text-neutral-600 dark:text-neutral-200">About</Link>
              </p>
              <p className="mb-4">
                <Link to="Store" className="text-neutral-600 dark:text-neutral-200">Store</Link>
              </p>
              <p>
                <Link to="/ContactUs" className="text-neutral-600 dark:text-neutral-200">Contact</Link>
              </p>
            </div>
            ...
            <div className>
              ...
              <p className="mb-4">
                <Link to="ProductFeature" className="text-neutral-600 dark:text-neutral-200">Feature</Link>
              </p>
              <p className="mb-4">
        ...
        <div  className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
          ...
          <Link  className="font-semibold text-neutral-600 dark:text-neutral-400" to="Landing">Arabic Recipes</Link>
        </div>
      </footer>
