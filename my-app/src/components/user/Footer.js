      ...
      <footer className="bg-black text-center text-  lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          ...
          <div className="flex justify-center">
            ...
            <a href="https://www.linkedin.com/in/razan-aboushi/" className="mr-6 text-white ">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
              </svg>
            </a>
            <a href="https://github.com/Ma6a3mkom/Ma6a3mkom" className="text-white ">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className>
              ...
              <p className="mb-4">
                <Link to="/ServicePageAll" className="text-white ">Restaurants</Link>
              </p>
              <p>
        ...
        <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700 text-white">
          ...
          <Link className="font-semibold text-white" to="Landing">Ma6a3mkom</Link>
        </div>
      </footer>
