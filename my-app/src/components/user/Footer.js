  ...
  return (
    ...
    <footer  className="bg-white text-center text-black  lg:text-left">
        ...
        <div  className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className>
              ...
              <p className="mb-4">
                <Link to="Store" className="text-black ">Restaurants</Link>
              </p>
              <p>
                <Link to="/ContactUs" className="text-black ">Contact</Link>
              </p>
            </div>
            {/* Contact section */}
            <div >
        ...
        <div  className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
          ...
          <Link  className="font-semibold text-black" to="Landing">Ma6a3mkom</Link>
        </div>
      </footer>
