  ...
  <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      ...
      <div className="mt-10 flex items-center justify-center gap-x-6">
        <HashLink smooth="true" to="#service"
    ...
    <div className="text-white relative px-4 py-10 bg-amber-900 shadow-lg sm:rounded-3xl sm:p-20">
      ...
      <label className="text-black font-bold mb-2" htmlFor="table_num">
        ...
        <input
          ...
          name="table_num"
        />
            {/* <label className="text-black font-bold mb-2" htmlFor="avalible_date">
                Available Date
            </label>
        <input
          className="shadow mb-4 appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"
        ...
        <input
          ...
          name="guest_num"
        />
            <label className="text-black font-bold mb-2" htmlFor="food_type">
                Food Type
            </label>
        <input
          className="shadow mb-4 appearance-none border rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"
        ...
        <label className="text-black font-bold mb-2" htmlFor="message">
                Description
        </label>
        <textarea
