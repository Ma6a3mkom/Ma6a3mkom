...
function PaymentPage() {
  ...
  const showAlert = () => {
    Swal.fire({
      title: 'Success pay',
      text: 'Thank you for Reservation from our website. We hope you will enjoy in the restaurant.',
      icon: 'success',
      confirmButtonText: 'OK',
    }).then((result) => {
      if (result.isConfirmed) {
        window.location.href = 'http://localhost:3000/'; // Replace with the URL of the desired page
      }
    });
  };
  return (
